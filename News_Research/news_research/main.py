...
# # Update FAISS index and metadata file paths relative to the current directory
# index_file_path = "News_Research/news_research/vector_index.faiss"
# metadata_file_path = "News_Research/news_research/vector_index_meta.pkl"
